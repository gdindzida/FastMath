...
TEST(GemmTest, TestMatMulTranspose) {
  // Arrange
  size_t n1 = 3ul;
  size_t n2 = 2ul;
  size_t n3 = 4ul;
  ...
  // Act
  algorithms::gemm_transpose(a, b, c);
...
TEST(GemmTest, TestMatMulBlock) {
  ...
  // Act
  algorithms::gemm_block(a, b, c, 32);
...
TEST(GemmTest, TestMatMulBlas) {
  ...
  cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, n1, n3, n2, 1.0,
              &(a.at(0, 0)), n2, &(b.at(0, 0)), n3, 0.0, &(c.at(0, 0)), n3);
